...
FOR TESTING
-------------
python fashion.py [background image] ./

python clothing.py [background image] [shirt to try on] [mask of background image]

background image = background.jpg
Shirt to try on = foreground.png
Mask of background image = backgroundmask.jpg
